...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(final DropGame game) {
        this.game = game;
        ...
        playButton.setPosition((DropGame.VIRTUAL_WIDTH - playBtnWidth * scale) / 2,  252);
        stage.addActor(playButton);
        creditsButton.setSize(creditBtnWidth * scale, creditBtnHeight * scale);
        creditsButton.setPosition((DropGame.VIRTUAL_WIDTH - creditBtnWidth * scale) / 2 + 70, 78);
