...
/**
 * Renderizador dedicado para desenhar fios conectando portas lógicas.
...
public class WireRenderer {
    ...
    /**
     * Cria um WireRenderer com seu próprio ShapeRenderer
     */
    public WireRenderer() {
     ...
     * @param shapeRenderer ShapeRenderer a ser usado
     */
    ...
    /**
     * Renderiza um único fio
     * @param wire O fio a ser desenhado
     * @param autoBeginEnd Se true, chama begin() e end() automaticamente
     */
    public void render(Wire wire, boolean autoBeginEnd) {
        ...
        for (int i = 0; i < points.size - 1; i++) {
            ...
            // Desenha linha grossa usando retângulo
    ...
    /**
     * Renderiza múltiplos fios
     * @param wires Array de fios a serem desenhados
     */
    public void renderAll(Array<Wire> wires) {
        ...
        for (Wire wire : wires) {
            render(wire, false); // false porque já chamamos begin()
        }
    ...
    /**
     * Desenha uma linha grossa entre dois pontos.
     * Usa um retângulo para ter controle sobre a espessura.
     */
    private void drawThickLine(float x1, float y1, float x2, float y2, float thickness) {
        ...
        // Desenha retângulo representando a linha
        shapeRenderer.rect(x1, y1, 0, 0, length, thickness, 1, 1, 
                          (float) Math.toDegrees(Math.atan2(dy, dx)));
    }
    
    /**
     * Versão alternativa usando linha simples do ShapeRenderer
     * Mais performático mas menos controle sobre aparência
     */
    public void renderSimple(Wire wire, boolean autoBeginEnd) {
        ...
        // shapeRenderer.set...() // LibGDX não tem controle direto de espessura
    ...
    /**
     * Renderiza fio com pontos de debug (útil para desenvolvimento)
     */
    ...
    /**
     * Libera recursos (só se este renderer criou o ShapeRenderer)
     */
    public void dispose() {
